...
//
//   .then(function (responsething) {
//     pokeArray = Array.from(responseThing)
//     pokeArray.forEach (function(element) {
//       singlePokeContainer = document.createElement('div');
//       containerForCard.appendChild(singlePokeContainer);
//       singlePokeContainer.style = 'display: inline-block;'
//       singlePokeContainer.innerHTML = `
//       <div>
//         <div  style='margin: 10px; background-color: yellow;'>
//           <p style="text-align: center;">${element.name}</p>
//           <br>
//           <img id=${element.id} src=${element.sprites.front}>
//           </div>
//       </div>
//       `
//       document.getElementById(`${element.id}`).addEventListener('click', function() {
//         if (document.getElementById(`${element.id}`).src === `${element.sprites.front}`) {
//
//           document.getElementById(`${element.id}`).src = `${element.sprites.back}`
//         }
//         else if(document.getElementById(`${element.id}`).src === `${element.sprites.back}`) {
//           document.getElementById(`${element.id}`).src = `${element.sprites.front}`
//         }
//       })
//     })
//
...
//   document.getElementById('pokemon-search-form').addEventListener('input', event => {
//   const filteredPokes = POKEMON.filter(pokeObj => pokeObj.name.includes(event.target.value.toLowerCase()))
//   const filteredPokeHTML = filteredPokes.map(element => (
//     `<div class="pokemon-container">
//       div>
//         <div  style='margin: 10px; background-color: yellow;'>
//           <p style="text-align: center;">${element.name}</p>
